...
model ChillerPlantSystem
  ...
  ChillerPlantSystem.Pump.Control.SecPumCon secPumCon(tWai=900, dPSetPoi=
        dP_nominal*0.5)
  ...
  Modelica.Blocks.Math.Add CooLoa
    annotation (Placement(transformation(extent={{168,-38},{148,-18}})));
equation
  ...
  connect(pumSecCHW.port_b, bui.port_a) annotation (Line(
      points={{78,-90},{140,-90},{140,18},{108,18}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=1));
  ...
  connect(CooLoa2.y,CooLoa. u1) annotation (Line(
      points={{199,90},{188,90},{188,-22},{170,-22}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(CooLoa1.y,CooLoa. u2) annotation (Line(
      points={{199,-50},{188,-50},{188,-34},{170,-34}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(CooLoa.y, bui.CooLoa) annotation (Line(
      points={{147,-28},{116,-28},{116,22},{108.9,22}},
      color={0,0,127},
      pattern=LinePattern.Dash));
