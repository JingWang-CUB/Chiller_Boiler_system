...
model BoilerPlantSystem_FMU
 ...
 package MediumHW =
  ...
  parameter Modelica.SIunits.MassFlowRate mHW_flow_nominal = 2762738.20/2/60/4200
  ...
  ChillerPlantSystem.CoSimulation.HeaLoa           heaLoa(tsta=6*86400, tend=14
        *86400)
...
equation
  ...
  connect(toDegC.Celsius, heaLoa.HW_temp) annotation (Line(
      ...
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(heaLoa.Loa, bui.CooLoa) annotation (Line(
      points={{159,50},{120,50},{120,22},{108.9,22}},
      color={0,0,127},
      pattern=LinePattern.Dash));
