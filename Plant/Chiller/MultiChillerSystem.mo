within WaterSideSystem.Plant.Chiller;
model MultiChillerSystem
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTCWEntChi(
    ...
    T_start=TCW_start)                 annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-70,-80})));
  BaseClasses.Components.Compressor ch1(redeclare package MediumCHW = MediumCHW,
  ...
  BaseClasses.Components.Compressor ch2(
  ...
  BaseClasses.Components.Compressor ch3(
    redeclare package MediumCHW = MediumCHW,
    redeclare package MediumCW = MediumCW,
    dPCHW_nominal=dPCHW_nominal,
    dPCW_nominal=dPCW_nominal,
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=ch1.chi.PLR1)
    annotation (Placement(transformation(extent={{60,-30},{80,-10}})));
  Modelica.Blocks.Sources.RealExpression realExpression1(y=ch2.chi.PLR1)
    annotation (Placement(transformation(extent={{60,-48},{80,-28}})));
  Modelica.Blocks.Sources.RealExpression realExpression2(y=ch3.chi.PLR1)
...
equation
  ...
  connect(port_b_CHW, port_b_CHW) annotation (Line(
      ...
      smooth=Smooth.None,
      thickness=1));
  connect(senTCWLeaChi.port_a, ch1.port_b_CW) annotation (Line(
      points={{-60,80},{-40,80},{-20,80},{-20,36}},
      color={0,127,255},
      thickness=1));
  ...
  connect(ch3.port_b_CHW, senTCHWLeaChi.port_a) annotation (Line(
      ...
      color={0,127,255},
      thickness=1));
  connect(ch1.TCHWSet, TCHWSet) annotation (Line(
      points={{-22,31},{-78,31},{-78,40},{-109,40}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(ch2.TCHWSet, TCHWSet) annotation (Line(
      points={{-22,-5},{-78,-5},{-78,40},{-109,40}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(ch3.TCHWSet, TCHWSet) annotation (Line(
      points={{-22,-45},{-78,-45},{-78,40},{-109,40}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  ...
  connect(realExpression.y, Rat[1]) annotation (Line(
      points={{81,-20},{90,-20},{90,-46.6667},{110,-46.6667}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(realExpression1.y, Rat[2]) annotation (Line(
      points={{81,-38},{95.5,-40},{110,-40}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(realExpression2.y, Rat[3]) annotation (Line(
      points={{81,-60},{96,-60},{96,-33.3333},{110,-33.3333}},
      color={0,0,127},
      pattern=LinePattern.Dash));
