...
model BypassControl "Condenser loop three way valve control"
  ...
  Modelica.Blocks.Sources.Constant Constant(k=TSet)
...
equation
  ...
  connect(Constant.y, conPID.u_s) annotation (Line(
