...
model ChillerPlantSystem_FMU_fault
  ...
  BaseClasses.Components.Building_fault  bui(
  ...
  ChillerPlantSystem.CoSimulation.CooLoa cooLoa(tsta=34*86400, tend=42*86400)
...
equation
  ...
  connect(cooLoa.TOutWetBul, froDegC.Celsius) annotation (Line(
      points={{159,32},{154,32},{154,-130},{-260,-130},{-260,-100.4},{-254,-100.4}},
      color={0,0,127},
      pattern=LinePattern.Dash));

  connect(froDegC.Kelvin, cooTowWithByp.TWetBul) annotation (Line(
      points={{-231,-100.2},{-200,-100.2},{-200,-36.4},{-189.26,-36.4}},
      color={0,0,127},
      pattern=LinePattern.Dash));
...
end ChillerPlantSystem_FMU_fault;
