...
model MultiChillers
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTCHWEntChi(
    ...
    m_flow_nominal=n*mCHW_flow_nominal) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={50,80})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTCWLeaChi(
    ...
    m_flow_nominal=n*mCW_flow_nominal) annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=0,
        origin={-82,80})));
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTCWEntChi(
    ...
    m_flow_nominal=n*mCW_flow_nominal) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-70,-80})));
  BaseClasses.Components.Compressor ch[n](
...
equation
  ...
  connect(ch.P, P) annotation (Line(
      points={{11,6},{50,6},{50,40},{110,40}},
      color={0,0,127},
      pattern=LinePattern.Dash));
