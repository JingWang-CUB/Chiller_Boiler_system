...
model PumpSystem
  ...
  BaseClasses.Components.PumpConstantSpeed      pumConSpeB(
    redeclare package Medium = Medium,
    Motor_eta=Motor_eta,
    Hydra_eta=Hydra_eta,
    m_flow_nominal=m_flow_nominal) "Constant Speed pump B"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  BaseClasses.Components.PumpConstantSpeed      pumConSpeC(
    redeclare package Medium = Medium,
    Motor_eta=Motor_eta,
    Hydra_eta=Hydra_eta,
    m_flow_nominal=m_flow_nominal) "Constant Speed pump C"
    annotation (Placement(transformation(extent={{-10,20},{10,40}})));
  BaseClasses.Components.PumpConstantSpeed      pumConSpeA(
    redeclare package Medium = Medium,
    Motor_eta=Motor_eta,
    Hydra_eta=Hydra_eta,
