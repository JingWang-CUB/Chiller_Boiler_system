...
model MutliCoolingTower
  ...
  ChillerPlantSystem.CoolingTower.MultiCoolingTowers      mulCooTowSys(
...
equation
  ...
  connect(OnA.y, mulCooTowSys.On[1]) annotation (Line(
      points={{-59,30},{-34,30},{-34,3.3},{-10.99,3.3}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(mulCooTowSys.On[2], OnB.y) annotation (Line(
      points={{-10.99,3.9},{-30,3.9},{-30,70},{59,70}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(OnC.y, mulCooTowSys.On[3]) annotation (Line(
      points={{59,30},{16,30},{-24,30},{-24,8},{-24,4.5},{-10.99,4.5}},
      color={0,0,127},
      pattern=LinePattern.Dash));
