within WaterSide.Plant.CoolingTower;
model MultiCoolingTowerSystem
  ...
  BaseClasses.Components.VSDCoolingTower ct1(
  ...
  BaseClasses.Components.VSDCoolingTower ct2(
    redeclare package MediumCW = MediumCW,
    P_nominal=P_nominal,
    dTCW_nominal=dTCW_nominal,
    dTApp_nominal=dTApp_nominal,
  ...
  BaseClasses.Components.VSDCoolingTower ct3(
      redeclare package MediumCW = MediumCW,
    P_nominal=P_nominal,
    dTCW_nominal=dTCW_nominal,
    dTApp_nominal=dTApp_nominal,
...
equation
  connect(ct1.port_a_CW, port_a_CW) annotation (Line(
      points={{-10,62},{-60,62},{-60,0},{-100,0}},
      color={0,127,255},
      thickness=1));
  connect(ct2.port_a_CW, port_a_CW) annotation (Line(
      points={{-10,0},{-100,0}},
      color={0,127,255},
      thickness=1));
  connect(ct3.port_a_CW, port_a_CW) annotation (Line(
      points={{-10,-60},{-60,-60},{-60,0},{-100,0}},
      color={0,127,255},
      thickness=1));
  connect(ct1.port_b_CW, port_b_CW) annotation (Line(
      points={{10,62},{60,62},{60,0},{100,0}},
      color={0,127,255},
      thickness=1));
  connect(ct2.port_b_CW, port_b_CW) annotation (Line(
      points={{10,0},{100,0}},
      color={0,127,255},
      thickness=1));
  connect(ct3.port_b_CW, port_b_CW) annotation (Line(
      points={{10,-60},{60,-60},{60,0},{100,0}},
      color={0,127,255},
      thickness=1));
  connect(ct1.TSet, TCWSet) annotation (Line(
      points={{-12,70},{-56,70},{-56,79},{-109,79}},
      color={0,0,127},
  ...
  connect(ct2.TWetBul, ct3.TWetBul) annotation (Line(
      ...
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(ct1.TWetBul, ct3.TWetBul) annotation (Line(
      points={{-12,58},{-68,58},{-68,-64},{-12,-64}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  ...
  connect(ct2.On, On[2]) annotation (Line(
      ...
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(ct1.On, On[1]) annotation (Line(
      points={{-12,66},{-20,66},{-30,66},{-30,33},{-109,33}},
      color={0,0,127},
      pattern=LinePattern.Dash));
